...
export default function Component() {
  return (
    <div className="min-h-screen bg-black text-primary font-mono overflow-hidden">
      <div className="relative z-10 p-4">
        ...
        <main className="container mx-auto py-12">
          ...
          <section id="about" className="mb-20">
            ...
            <p className="text-secondary leading-relaxed">
              I am a Java developer specializing in Minecraft plugins and REST APIs, I started
              programming at the age of 12. I believe users should have the option to customize
              every aspect of the software they use, and I design everything with that in mind.
              I&apos;m passionate about contributing to open-source projects, pentesting servers,
              and helping others fix vulnerabilities.
            </p>
          </section>
          ...
          <section id="contact" className="text-center">
            ...
            <p className="text-secondary mb-6">Let&apos;s connect and bring your idea to life!</p>
            <a
        ...
        <footer className="py-6 text-center">
          ...
          <p className="text-dark">
            &copy; {new Date().getFullYear()} NonSwag | All rights reserved | I &lt;3 OpenSource{" "}
          </p>
        </footer>
      </div>
    </div>
